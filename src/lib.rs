...
pub trait Transport: ::std::fmt::Debug + Clone {
    /// The type of future this transports returns when a call is made.
...
mod tests {
    ...
    fn should_allow_to_use_arc_as_transport() {
        ...
        let _rpc_1 = NearRpc::new(transport);
        let _rpc_2 = NearRpc::new(transport2);
    }
}